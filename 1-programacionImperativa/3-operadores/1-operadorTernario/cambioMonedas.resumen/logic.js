...
msg = msg + conins50 > 0 ? coin50 + COINS_OF + 50 + "\n" : "";
msg = msg + coins20 > 0 ? coin20 + COINS_OF + 20 + "\n" : "";
msg = msg + coins10 > 0 ? coin10 + COINS_OF + 10 + "\n" : "";
msg = msg + coins5 > 0 ? coin5  + COINS_OF + 5 + "\n" : "";
msg = msg + coins2 > 0 ? coin2 + COINS_OF + 2 + "\n" : "";
